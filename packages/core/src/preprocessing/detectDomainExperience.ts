...
const STOP_WORDS = new Set([
  "a", "an", "and", "the", "this", "that", "these", "those", "i", "you", "he", "she", "it", "we", "they",
  "me", "him", "her", "us", "them", "my", "your", "his", "her", "its", "our", "their",
  "have", "has", "had", "do", "does", "did", "am", "is", "are", "was", "were", "be", "being", "been",
  "can", "could", "will", "would", "shall", "should", "may", "might", "must", "ought",
  "get", "got", "make", "made", "go", "went", "come", "came",
  "in", "on", "at", "to", "by", "for", "from", "with", "about", "of", "as", "or", "up", "out", "if",
  "into", "through", "during", "before", "after", "above", "below", "between", "under", "again", "further",
  "years", "year", "experience", "job", "position", "role", "work", "company", "project", "team",
  "skill", "skills", "profile", "cv", "resume", "contact", "email", "phone", "address", "location",
  "date", "current", "present",
  "o", "a", "um", "uma", "os", "as", "uns", "umas", "de", "em", "por", "com", "sem", "para", "sob",
  "sobre", "são", "é", "está", "estão", "foi", "foram",
]);
