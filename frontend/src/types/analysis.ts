 ...
 * ============================================================
 * These types support graceful degradation when the primary
 * backend AI provider (Groq) fails. The backend sends a
 * structured fallback response with prompts for frontend
 * to use with an alternative provider (Firebase Vertex AI).
 */
...
/**
 * Response from backend when primary AI provider fails
 * Contains original prompts for frontend to use with fallback provider
 */
